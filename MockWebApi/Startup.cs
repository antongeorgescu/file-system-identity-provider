            ...
            services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
                .AddJwtBearer(options =>
                {
                    options.TokenValidationParameters =
                        ...
                        {
                            // if we do not want to store in this service the signing key, the next line of code will be commented out
                            //IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF32.GetBytes(Configuration["Jwt:PrivateKey"])),
                            // if this service receives tokens generated by multiple issuers, the next 2 lines of code are commented out
